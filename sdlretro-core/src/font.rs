...
pub const SMALL_FONT_GLYPHS: &[FontGlyph] = &[
    ...
    FontGlyph { step_width: 6, width: 5, height: 5, x: 0, y: -5, data_offset: 490 },   // 0x6E (n)
    FontGlyph { step_width: 6, width: 5, height: 5, x: 0, y: -5, data_offset: 495 },   // 0x6F (o)
    FontGlyph { step_width: 6, width: 5, height: 6, x: 0, y: -5, data_offset: 499 },   // 0x70 (p)
    FontGlyph { step_width: 6, width: 5, height: 6, x: 0, y: -5, data_offset: 506 },   // 0x71 (q)
    FontGlyph { step_width: 5, width: 4, height: 5, x: 0, y: -5, data_offset: 512 },   // 0x72 (r)
    FontGlyph { step_width: 5, width: 4, height: 5, x: 0, y: -5, data_offset: 517 },   // 0x73 (s)
    FontGlyph { step_width: 4, width: 3, height: 7, x: 0, y: -7, data_offset: 522 },   // 0x74 (t)
    FontGlyph { step_width: 6, width: 5, height: 5, x: 0, y: -5, data_offset: 529 },   // 0x75 (u)
    FontGlyph { step_width: 6, width: 5, height: 5, x: 0, y: -5, data_offset: 534 },   // 0x76 (v)
    FontGlyph { step_width: 8, width: 7, height: 5, x: 0, y: -5, data_offset: 539 },   // 0x77 (w)
    FontGlyph { step_width: 6, width: 5, height: 5, x: 0, y: -5, data_offset: 544 },   // 0x78 (x)
    FontGlyph { step_width: 6, width: 5, height: 6, x: 0, y: -5, data_offset: 549 },   // 0x79 (y)
    FontGlyph { step_width: 6, width: 5, height: 5, x: 0, y: -5, data_offset: 555 },   // 0x7A (z)
    FontGlyph { step_width: 4, width: 3, height: 8, x: 0, y: -8, data_offset: 560 },   // 0x7B ({)
    FontGlyph { step_width: 3, width: 2, height: 8, x: 0, y: -8, data_offset: 568 },   // 0x7C (|)
    FontGlyph { step_width: 4, width: 3, height: 8, x: 0, y: -8, data_offset: 576 },   // 0x7D (})
